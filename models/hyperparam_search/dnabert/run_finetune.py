...
### *** Test run for fine-tuning by project group 8: cleavage prediction is hardcoded into argarse *** ###
### more info: https://github.com/jerryji1993/DNABERT ###
...
def main():
    ...
    parser.add_argument(
        "--per_gpu_train_batch_size", default=512, type=int, help="Batch size per GPU/CPU for training.",
    )
    parser.add_argument(
        "--per_gpu_eval_batch_size", default=512, type=int, help="Batch size per GPU/CPU for evaluation.",
    )
    parser.add_argument(
